...
def progress(num_steps: int, metrics: types.Metrics | dict):
    ...
    save_path = script_dir / "progress" / train_id / "progress_{timestamp}.png"
...
def visualize_policy(current_step: int, make_policy, params):
    try:
        ...
        for f_idx, frame in enumerate(frames):
            ...
            # Add text
            # TODO: Add reward components and cumulative reward 
            text_lines = [
