...
train_id = "cassie_find_eq_torques_5"  # This training is purely to find the torques required to hold the standing pose
env = CassieEnv()
...
restore_ckpt_path = script_dir / "checkpoints/cassie_find_eq_torques_5/000024084480"
